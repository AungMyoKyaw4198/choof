...
class AddVideoPage extends StatefulWidget {
  final Group group;
  const AddVideoPage({Key? key, required this.group}) : super(key: key);
                    ...
                    children: [
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  suffixIcon: IconButton(
                                    onPressed: () {
                                      addVideoController.youtubeLink.clear();
                                    },
                      ...
                      Obx(
                        () => addVideoController.isVerify.isTrue
                            ? Image.network(
                                addVideoController.youtubeThumbnail.string,
                                height: 200,
                                fit: BoxFit.cover,
                              )
                            : Container(
                              ...
                              onFieldSubmitted: (value) {
                                if (value.isNotEmpty) {
                                  ...
                                  if (value.contains(',')) {
                                    ...
                                    addVideoController.addTags(value.trim());
                                  }
                                }
                                addVideoController.tagName.clear();
                              },
                                ...
                                if (addVideoController
                                  ...
                                  if (addVideoController.tagName.text
                                    ...
                                    addVideoController.addTags(
                                        addVideoController.tagName.text.trim());
                                  }
                                }
                                addVideoController.tagName.clear();
                              },
                        ...
                        child: Obx(
                          () => addVideoController.tagList.isNotEmpty
                              ? ListView.builder(
                                  ...
                                  itemCount: addVideoController.tagList.length,
                                      ...
                                      child: Stack(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Text(
                                              addVideoController.tagList[index],
                                              style: const TextStyle(
                                                  color: Colors.white,
                                                  fontWeight: FontWeight.bold),
                                            ),
