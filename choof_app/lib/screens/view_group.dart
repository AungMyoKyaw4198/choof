...
class ViewGroup extends StatefulWidget {
  ...
  const ViewGroup(
      {Key? key, required this.currentGroup, required this.isFromGroup})
      : super(key: key);
            ...
            landingPagecontroller.userProfile.value.name ==
                ...
                ? Row(
                    children: [
                      InkWell(
                        onTap: () {
                          viewGroupController.deleteGroup(widget.currentGroup);
                        },
                        child: const Align(
              ...
              Row(
                ...
                children: [
                      ...
                      Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  fit: BoxFit.fill,
                                  image: NetworkImage(
                                      widget.currentGroup.ownerImageUrl)))),
                      const SizedBox(
                        width: 10,
                      ),
                      const Text(
                  ...
                  Row(
                    ...
                    children: [
                      Obx(() {
                        if (landingPagecontroller.groupedUsers.isEmpty) {
                          return const SizedBox.shrink();
                        } else if (landingPagecontroller.groupedUsers.length ==
                            1) {
                          return InkWell(
                            onTap: () {
                              Get.to(() =>
                                  FriendsPage(group: widget.currentGroup));
                            },
                            child: const Text(
                              'Add Friends',
                          ...
                          for (var member
                              in landingPagecontroller.groupedUsers) {
                            if (member.name != widget.currentGroup.owner) {
                      ...
                      // Show +7
                      Obx(() {
                        if (landingPagecontroller.groupedUsers.isNotEmpty) {
                          List<Profile> groupMembers = [];
                          for (var member
                              in landingPagecontroller.groupedUsers) {
                            if (member.name != widget.currentGroup.owner) {
                      ...
                      InkWell(
                        onTap: () {
                          Get.to(() => FriendsPage(group: widget.currentGroup));
                        },
                        child: Image.asset(
              ...
              Container(
                ...
                child: ListView(
                  ...
                  children: [
                            ...
                            children: [
                              Autocomplete<String>(
                                ...
                                onSelected: (String selection) {
                                  viewGroupController.addTags(selection);
                                  tagName.clear();
                    ...
                    // Show Filtered tags
                    Obx(
                      () => viewGroupController.filteredTags.isNotEmpty
                          ? ListView.builder(
                              shrinkWrap: true,
                              scrollDirection: Axis.horizontal,
                              itemCount:
                                  viewGroupController.filteredTags.length,
                  ...
                  : !viewGroupController.isFilter.value
                      ...
                      viewGroupController.posts.isEmpty
                          ...
                          : ListView.builder(
                              ...
                              itemCount: viewGroupController.posts.length,
                              itemBuilder: (context, index) {
                                ...
                                return landingPagecontroller
                                    ...
                                    ? Stack(
                                        children: [
                                          ...
                                          InkWell(
                                            onTap: () {
                                              viewGroupController.deletePost(
                                                  widget.currentGroup,
                                                  currentPosts[index]);
                                            },
                                            child: const Align(
                      ...
                      // Filtered
                      : viewGroupController.filteredTagResult.isEmpty
                          ? const Center(
                              child: Text(
                                'No Result Found',
                                style: TextStyle(color: Colors.white),
                          ...
                          : ListView.builder(
                              ...
                              physics: const ClampingScrollPhysics(),
                              itemCount:
                                  viewGroupController.filteredTagResult.length,
                              itemBuilder: (context, index) {
                                List<Post> currentPosts =
